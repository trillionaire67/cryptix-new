...
public class Block
{
    ...
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos)
    {
        ...
        float efficiency = playerIn.getToolDigEfficiency(this, false);
        return f < 0.0F ? 0.0F : (!playerIn.canHarvestBlock(this) ? efficiency / f / 100.0F : efficiency / f / 30.0F);
    }
    
    public float getPlayerRelativeBlockHardness(EntityPlayer playerIn, World worldIn, BlockPos pos, boolean ignoreSlow)
    {
        float f = this.getBlockHardness(worldIn, pos);
        float efficiency = playerIn.getToolDigEfficiency(this, ignoreSlow);
        return f < 0.0F ? 0.0F : (!playerIn.canHarvestBlock(this) ? efficiency / f / 100.0F : efficiency / f / 30.0F);
    }
