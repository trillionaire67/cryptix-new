...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveFlying(float strafe, float forward, float friction)
    {
        ...
        if (f >= 1.0E-4F)
        {
            ...
            float f1 = MathHelper.sin((Client.movefix ? EventManager.ROTATION_EVENT.getYaw() : this.rotationYaw) * (float)Math.PI / 180.0F);
            float f2 = MathHelper.cos((Client.movefix ? EventManager.ROTATION_EVENT.getYaw() : this.rotationYaw) * (float)Math.PI / 180.0F);
