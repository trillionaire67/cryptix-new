...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z)}))
        {
            ...
            if (Client.instance.moduleManager.getModuleByName("Chams").isToggled() && entity instanceof EntityPlayer && !AntiBot.isBot(entity)) {
            ...
            try
            {
                ...
                if(entity == renderManager.livingPlayer) {
                	f1 = this.interpolateRotation(entity.prevFakeYaw, entity.fakeYaw, partialTicks);
                }else {
                ...
                float f7;
                if(entity == renderManager.livingPlayer) {
                	f7 = entity.prevFakePitch + (entity.fakePitch - entity.prevFakePitch) * partialTicks;
                }else {
    ...
    {
    	if(entity instanceof EntityPlayer && !entity.isDead && Client.instance.moduleManager.getModuleByName("NameTags").isToggled()) return;
