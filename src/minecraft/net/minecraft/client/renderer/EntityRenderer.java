...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void updateRenderer()
    {
        ...
        pos.setPosition(d2, d0, d1);
        float f2 = this.mc.theWorld.getLightBrightness(pos);
    ...
    public void updateCameraAndRender(float partialTicks, long nanoTime)
    {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            final ScaledResolution scaledresolution = RenderCache.getScaledResolution();
    ...
    {
        this.setupOverlayRendering();
        this.mc.ingameGUI.renderStreamIndicator(RenderCache.getScaledResolution());
    }
    ...
    {
        ScaledResolution scaledresolution = RenderCache.getScaledResolution();
        GlStateManager.clear(256);
        GlStateManager.matrixMode(5889);
        GlStateManager.loadIdentity();
