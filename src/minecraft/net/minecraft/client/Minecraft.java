...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        {
            this.displayGuiScreen(new GuiConnecting(MainMenu.instance, this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(MainMenu.instance);
        }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    {
                    	Client.instance.moduleManager.onKey(k);
                    	Client.instance.scriptManager.onKey(k);
                        if (k == 1)
                        {
